...
<body>
<h3 align="center">编辑商家</h3>
<form action="${pageContext.request.contextPath}/storeUpdateServlet" method="post">
    <div class="overall">
        <div class="leftImage">
            <div class="image">
                <div id="upImg" class="upImg">
                    <label class="inputLabel" for="inputFile">
                        <img style="width: 200px;" src="${pageContext.request.contextPath}/images/addImg.png"/></label>
                    <%--                    <c:set var="images" value="${fn:split(good.images,',')}"></c:set>--%>
                    <%--                    <c:forEach var="image" items="${images}" step="1">--%>
                    <%--                        <div class="container">--%>
        ...
        <table>
            <tr>
                <td><b>名称:</b></td>
                <td><input id="name" type="text" name="name" placeholder="${store.name}"/></td>
                <td><input id="images" name="images" type="hidden"/></td>
            </tr>
            <tr>
                <td><b>信息：</b></td>
                <td><input type="text" name="info" placeholder="${store.info}"/></td>
            </tr>
            <tr>
                <td><b>地址:</b></td>
                <td><input type="text" name="price" placeholder="${store.address}"/></td>
            </tr>
            <tr>
                <td><b>联系电话:</b></td>
                <td><input type="text" name="price" placeholder="${store.address}"/></td>
